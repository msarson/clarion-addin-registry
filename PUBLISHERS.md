...
**Forking and publishing your fork is fine.** That is what an open source licence is for. If the
original is unmaintained, or you have taken it somewhere the author did not want to go, fork it,
develop it, release it from your own account and list it here. Mark it with `fork` and
`upstreamUrl` so users can see where it came from, honour the original licence, and it is yours to
publish. Some of the best addins here are forks that outgrew their originals.

**Listing somebody else's release is a different thing.** Publishing a fork means shipping your own
build, from your own repository, with your name against it. Taking an addin that someone else
actively maintains and listing it as though you were its route to users is not that — a licence
gives you the right to redistribute, but it does not tell you the author wanted their work listed
under someone else's name in a place they did not choose. If they are still shipping it, ask, and
prefer the outcome where they list it themselves: their entry, their release schedule, their name
against it.

The registry enforces the narrow version mechanically — an addin's downloads must come from the
publisher's own GitHub account, so you cannot list software served from somebody else's. That check
is also what makes the fork case clean: your fork, your releases, your account. But do not treat
passing it as having asked.
